...
```{r dplyr cheat sheet 1, echo=FALSE, fig.align="center", out.width = '100%',fig.cap="Figure: Data Transformation with dplyr 1"}
knitr::include_graphics("./02_Plots/data_transformation1.png")
```


```{r dplyr cheat sheet 2, echo=FALSE, fig.align="center", out.width = '100%',fig.cap="Figure: Data Transformation with dplyr 2"}
...
```{r function,echo = T,message = FALSE, error = FALSE, warning = FALSE}
```
