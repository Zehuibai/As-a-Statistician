...
o A special case of this model is when the times are equal to $\$ 1,2,3$, Vidots, $\mathrm{p} \$$. Then the \$p $\mathrm{p}$ \$ blocks of the variance-covariance matrix become:
$$
\sigma^{2}\left[\begin{array}{ccccc}
