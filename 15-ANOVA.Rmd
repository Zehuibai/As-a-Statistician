...
```{r ANOVA unbalance, echo=FALSE, fig.align="center", out.width = '100%',fig.cap="Figure: Graphical Depiction of the Drug Data Set"}
knitr::include_graphics("./02_Plots/Unbalanced_ANOVA.png")
```
